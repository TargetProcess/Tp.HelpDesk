...
namespace Hd.Web.Extensions
{
    ...
    public class Pager : WebControl, INamingContainer
    {
        ...
        private void BuildControlHierarchy()
        {
            ...
            //table.Cells.Add(cellPageDescription);

            // TableCell nextCell = new TableCell();
            // table(nextCell);

            Panel table = new Panel();
            BuildPrevButton(table);
            BuildDescription(table);
            BuildNextButton(table);
            Controls.Add(table);
        }

        private void BuildDescription(Panel cell)
        {
            int startCount = 0;
            int endCount = 0;
            ...
            cell.Controls.Add(new Label { Text = recordsText });
        }

        private void BuildNextButton(Panel cell)
        {
            ...
            LinkButton next = new LinkButton {ID = "Next"};
