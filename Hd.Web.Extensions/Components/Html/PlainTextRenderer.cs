...
namespace Tp.Web.Extensions.Components
{
	...
	public class PlainTextRenderer : Sanitizer
	{
		...
		/// </summary>
		private readonly ISet<string> BlockElementTags = new HashSet<string>
		                                                 	{
		                                                 		// Headings
		                                                 		"h1",
		                                                 		"h2",
		...
		protected override void Before(TextWriter result)
		{
			//
		}

		protected override void After(TextWriter result)
		{
			//
		}

		protected override void WriteElement(TextWriter result, string name, StringDictionary attributes, bool empty)
		{
		...
		protected override void WriteString(TextWriter result, string value)
		{
			if (TopTag() == "pre")
			{
				result.Write(value);
